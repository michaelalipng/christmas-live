-- ============================================================================
-- READY TO RUN - All 20 Christmas trivia polls for event: Christmas Service Test
-- Event ID: 1faf5346-465e-4016-967c-adeab5e81fc4
-- ============================================================================

-- Poll 1: Home Alone
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'In the movie Home Alone where are the McCallisters going on vacation when they leave Kevin behind', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'What is the main spice that gives classic gingerbread cookies their flavor', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'Which reindeer is famous for having a shiny red nose', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'Which country is widely credited with starting the tradition of the decorated Christmas tree', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'In the song The Twelve Days of Christmas how many total gifts are given by the end of the song', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'What popular Christmas drink is also sometimes called milk punch', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'In How the Grinch Stole Christmas what is the name of the Grinch dog', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'In the movie A Christmas Story what gift does Ralphie want more than anything', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'Which of these is NOT one of Santas reindeer', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'What color are the berries of the traditional mistletoe plant', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'In which modern day country was Saint Nicholas born', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'Which Christmas carol includes the line Fall on your knees', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'What is the name for the season of preparation leading up to Christmas in many churches', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'In the movie Elf what is the first rule of The Code of Elves', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'Which plant is known as the Christmas star due to its bright red leaves', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'In A Christmas Carol what is the name of Scrooge cheerful clerk', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'What is the name of the famous Christmas ballet featuring Clara and the Sugar Plum Fairy', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'In the song Rudolph the Red Nosed Reindeer what do the other reindeer not let Rudolph do', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'Under which decoration do people traditionally share a Christmas kiss', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
...
WITH new_poll AS (
  INSERT INTO polls (event_id, question, state, duration_seconds, results_seconds)
  VALUES ('1faf5346-465e-4016-967c-adeab5e81fc4'::UUID, 'Which of these countries celebrates Christmas during its summer season', 'scheduled', 30, 8)
  RETURNING id
),
options AS (
  INSERT INTO poll_options (poll_id, label)
